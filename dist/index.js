...
var relatorios = mysqlTable("relatorios", {
  id: int("id").autoincrement().primaryKey(),
...
async function getRelatorios() {
  ...
  try {
    const result = await db.select().from(relatorios).orderBy((t2) => t2.createdAt);
    console.log("[Database] getRelatorios result:", result.length, "relat\xF3rios encontrados");
    return result;
  } catch (error) {
...
var appRouter = router({
  ...
  rso: router({
    create: publicProcedure.input(z2.object({
      encarregadoNome: z2.string().min(1),
      encarregadoSobrenome: z2.string().min(1),
      encarregadoPatente: z2.string().min(1),
      viaturaPrefixo: z2.string().min(1),
      chefeBarcaPatente: z2.string().min(1),
      chefeBarcaNome: z2.string().min(1),
      motoristaPatente: z2.string().min(1),
      motoristaNome: z2.string().min(1),
      terceirohomemPatente: z2.string().min(1),
      terceirohomemNome: z2.string().min(1),
      quartohomemPatente: z2.string().min(1),
      quartohomemNome: z2.string().min(1),
      quintohomemPatente: z2.string().min(1),
      quintohomemNome: z2.string().min(1),
      dataInicio: z2.date(),
      dataFim: z2.date(),
      totalOcorrencias: z2.number().int().nonnegative().default(0),
      drogasApreendidas: z2.number().int().nonnegative().default(0),
      dinheiroSujoApreendido: z2.number().nonnegative().default(0),
      armamentoApreendido: z2.number().int().nonnegative().default(0),
      municaoApreendida: z2.number().int().nonnegative().default(0),
      bombasApreendidas: z2.number().int().nonnegative().default(0),
      lockpikApreendidas: z2.number().int().nonnegative().default(0),
      relacaoDetidosBos: z2.string().optional(),
      acoesRealizadas: z2.string().optional(),
    ...
    list: publicProcedure.query(async () => {
      ...
      try {
        const relatorios2 = await getRelatorios();
        console.log("[tRPC] rso.list returning", relatorios2.length, "relatorios");
        return relatorios2;
      } catch (error) {
    ...
    update: adminProcedure.input(z2.object({
      id: z2.number().int(),
      data: z2.object({
        encarregadoNome: z2.string().optional(),
        encarregadoSobrenome: z2.string().optional(),
        encarregadoPatente: z2.string().optional(),
        viaturaPrefixo: z2.string().optional(),
        chefeBarcaPatente: z2.string().optional(),
        chefeBarcaNome: z2.string().optional(),
        motoristaPatente: z2.string().optional(),
        motoristaNome: z2.string().optional(),
        terceirohomemPatente: z2.string().optional(),
        terceirohomemNome: z2.string().optional(),
        quartohomemPatente: z2.string().optional(),
        quartohomemNome: z2.string().optional(),
        quintohomemPatente: z2.string().optional(),
        quintohomemNome: z2.string().optional(),
        dataInicio: z2.date().optional(),
        dataFim: z2.date().optional(),
        totalOcorrencias: z2.number().int().nonnegative().optional(),
        drogasApreendidas: z2.number().int().nonnegative().optional(),
        dinheiroSujoApreendido: z2.number().nonnegative().optional(),
        armamentoApreendido: z2.number().int().nonnegative().optional(),
        municaoApreendida: z2.number().int().nonnegative().optional(),
        bombasApreendidas: z2.number().int().nonnegative().optional(),
        lockpikApreendidas: z2.number().int().nonnegative().optional(),
        relacaoDetidosBos: z2.string().optional(),
        acoesRealizadas: z2.string().optional(),
        observacoes: z2.string().optional()
      }).partial()
